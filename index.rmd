...
mytable = data.frame(
    ...
    Topics = c("Introduction to the course <br>Basic concepts of research design", 
               "Introduction to R & R Markdown I", 
               "Introduction to R & R Markdown II<br>Descriptive analytics", 
               "Descriptive analytics<br>Introduction to inferential statistics",
               "Supervised learning I",
               "Supervised learning II",
               "Experimental design <br>Group project coaching",
               "Exam"
               ),
    Chapters = c("1, except: <br>1.2.3.1., <br>1.2.3.1.2.1, <br>1.2.3.2.2",
                 "2, 3, 4", 
                 "2, 3, 4", 
                 "4, 5", 
                 "6",
                 "6",
                 "1: 1.2.3.1., 1.2.3.1.2.1, 1.2.3.2.2",
                 "--"
                 ))
