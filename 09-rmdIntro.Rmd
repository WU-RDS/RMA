...
#track_data <- distinct(track_data)
...
ggplot(track_data_scale,aes(x=danceability)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=energy)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=loudness)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=mode)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=speechiness)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=acousticness)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=instrumentalness)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=liveness)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=valence)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=tempo)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
ggplot(track_data_scale,aes(x=duration_ms)) + geom_histogram(color="white",fill="lavenderblush3") + theme_bw()
```
...
opt_K <- NbClust(track_data_scale %>% select(danceability:duration_ms), method = "kmeans", max.nc = 11)
...
track_data %>% filter(trackName == "Monkey Wrench") %>% select(trackName, artistName, cluster)
```
