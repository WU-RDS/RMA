...
<p class="caption">(\#fig:unnamed-chunk-6)Bar chart (step 1)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-7)Bar chart (step 2)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-8)Bar chart (step 3)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-9)Bar chart (step 4)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-10)Bar chart (step 5)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-11)Bar chart (options 1)</p>
</div>
...
<img src="06-retail_metrics_files/figure-html/unnamed-chunk-15-1.png" width="672" />
...
<p class="caption">(\#fig:unnamed-chunk-21)Histogram</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-22)Histogram 2</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-24)Boxplot by group</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-27)Single Boxplot</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-30)Plot of means</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-32)Grouped plot of means</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-33)Scatter plot</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-34)Grouped scatter plot</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-37)Line plot</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-39)Line plot (by region)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-40)Line plot (facet wrap)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-46)Secondary y-axis</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-48)Boxplot using ggstatsplot package</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-49)Scatter plot with histogram</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-51)Covariation between categorical data (1)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-52)Covariation between categorical data (2)</p>
</div>
...
<img src="06-retail_metrics_files/figure-html/ggmaps-1.png" width="672" />
...
<img src="06-retail_metrics_files/figure-html/unnamed-chunk-57-1.png" width="672" />
...
<img src="06-retail_metrics_files/figure-html/unnamed-chunk-58-1.png" width="50%" />
