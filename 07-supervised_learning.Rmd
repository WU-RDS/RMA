...
* bonus buy (&beta;<sub>2</sub>): when bonus buy increases by 1% (which is one step on a scale from 0 to 100 for a discount, i.e., this is equal to 1-unit increase), sales will change by `r round(summary(multiple_sales_reg)$coefficients[3],3)*100`%
